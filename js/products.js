  ...
  <article class="product-card" itemscope itemtype="https://schema.org/Product">
    <a href="#" aria-label="${p.name}">
      <div class="product-img-wrap">
        <img src="${p.img}" alt="${p.name} - cozybabie" loading="lazy" itemprop="image" />
...
// Cart state
let cart = JSON.parse(localStorage.getItem('cozybabie_cart') || '[]');
...
function addToCart(id) {
  ...
  localStorage.setItem('cozybabie_cart', JSON.stringify(cart));
  updateCartCount();
  showAddedFeedback();
}
